...
hr_df=pd.get_dummies(hr_df,columns=['region','department','education','gender','recruitment_channel'])

#converting categorical data into numbers in test data
hr_test=pd.get_dummies(hr_test,columns=['region','department','education','gender','recruitment_channel'])
...
modelXg = XGBClassifier(learning_rate=0.1, n_estimators=200, max_depth=7, min_child_weight=4, 
...
y_xg.to_csv("C:/Users/ssn/Desktop/capstone/abalytics/GB1.csv")
